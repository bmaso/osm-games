...
)) :named test-case.game-ops.validation.second-bonus-throw-entanglement-without-mark))
...
)) :named test-case.game-ops.validation.second-bonus-throw-entanglement-with-spare ))
...
)) :named test-case.game-ops.validation.two-consecutive-spares-bonus-entanglement ))
